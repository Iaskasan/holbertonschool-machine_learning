...
class Node:
    ...
    def update_bounds_below(self):
        """Recursively update lower and upper bounds for all child nodes
        based on the current node's split feature and threshold."""
        if self.is_root:
            self.upper = {0: np.inf}
...
class Decision_Tree():
    ...
    def update_bounds(self):
        """Initialize and propagate feature bounds
        updates starting from the root node."""
